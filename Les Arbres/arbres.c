...
void parcoursProfondeurA(Noeud* racine)
{
  if (racine != NULL)
  {
    printf("%c", racine->donnee);
    parcoursProfondeurA(racine->g);
    parcoursProfondeurA(racine->d);
  }
}


void parcoursProfondeurI(Noeud* racine)
{
  if (racine != NULL) // sortie
  {
    parcoursProfondeurI(racine->g); //
    printf("%c", racine->donnee);
    parcoursProfondeurI(racine->d); //
  }
}

void parcoursProfondeurP(Noeud* racine)
{
  if (racine != NULL)
  {
    parcoursProfondeurP(racine->g);
    parcoursProfondeurP(racine->d);
    printf("%c", racine->donnee);
  }
}
...
int main(int argc, char** argv)
{
  ...
  //printf("\nImpression Avant : ");
  //parcoursProfondeurA(racine);
  //printf("\nImpression Entre : ");
  //parcoursProfondeurI(racine);
  //printf("\nImpression Après : ");
  //parcoursProfondeurP(racine);
  //printf("\n");
  libererNoeud(racine);*/
  ...
  imprimerArbre(&f);
  printf("\nImpression Avant : ");
  parcoursProfondeurA(&f);
  printf("\nImpression Entre : ");
  parcoursProfondeurI(&f);
  printf("\nImpression Après : ");
  parcoursProfondeurP(&f);
  printf("\n");
